...
function SprintCard({ phase, sprintIndex, isActive, isCompleted, isFuture, currentUser, isOwner, members, onRefresh, onTaskUpdated, onGoToFeedback }) {
  ...
  <p className="text-xs text-gray-600">Când începi task-ul apasă <strong className="text-blue-600">Începe task-ul</strong> sau adaugă un comentariu / fișier PDF pentru a intra în lucru automat.</p>
</div>
